...
. Your first task is to edit the `Accelerometer-Info-Summary.md` file in the template project and fill in the missing parts by looking at the ADXL345 data sheet (available through Canvas).
