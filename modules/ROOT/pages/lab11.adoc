...
. Create an application based on <<program-interrupt-responder-with-thread>>.
. Use of the events subsystem requires adding the appropriate entry (`CONFIG_EVENTS=y`) to your `prj.conf` file.
. Build and flash the application to your nRF52840 DK.
