...
. Now observe what happens when you change the resistance.  Replace the 10 k{Omega} resistor with a 1.5 k{Omega} resistor (brown-green-red). What differences do you observe on the oscilloscope?
...
. Create the repository using the GitHub Classroom link on Canvas.
