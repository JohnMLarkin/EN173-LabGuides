...
. Connect the flywire labeled *1+* (top left, orange) to the same column as the output pin of the button (the one that is connected to P0.03).  Connect the flywire labeled *1-* (bottom left, orange with white stripe) to the ground bus strip.  Connect the ground (pass:[<i class="fa-solid fa-arrow-down"></i>]) flywire to the ground bus strip.
