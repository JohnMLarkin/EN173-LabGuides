...
. Kirchhoff's voltage law tells us that stem:[\Delta V_\mathrm{total} = \Delta V_R + \Delta V_\mathrm{LED}] {Delta}V~total~ = {Delta}V~R~ + {Delta}V~LED~ (assuming there are insignificant voltage drops at the various junctions).  Do your measurements agree?
