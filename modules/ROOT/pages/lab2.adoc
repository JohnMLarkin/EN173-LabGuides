...
After you have assembled this circuit on the breadboard, create a new PlatformIO project. Copy `mbed_app.json` from one of your previous projects to this one (or get it from Blackboard). Then enter <<program-red-green-LEDs>>. 