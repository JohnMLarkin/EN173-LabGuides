...
. If your first name comes first alphabetically on your team, you are the team lead for this assignment. It is your job to access the GitHub Classroom assignment link first and create the team name (as found on Blackboard).
+
